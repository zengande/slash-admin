...
/** 实体审计用户全属性数据传输对象 */
interface FullAuditedEntityWithUserDto<TPrimaryKey, TUserDto> extends AuditedEntityWithUserDto<TPrimaryKey, TUserDto>, FullAuditedEntityDto<TPrimaryKey> {
	/** 删除人实体数据传输对象 */
	deleter: TUserDto;
}
/** 实体扩展属性数据传输对象 */
...
/** 实体新增扩展属性数据传输对象 */
interface ExtensibleCreationAuditedEntityDto<TPrimaryKey> extends CreationAuditedEntityDto<TPrimaryKey>, ExtensibleEntityDto<TPrimaryKey> {}
/** 实体新增用户扩展属性数据传输对象 */
...
/** 实体审计扩展属性数据传输对象 */
interface ExtensibleAuditedEntityDto<TPrimaryKey> extends AuditedEntityDto<TPrimaryKey>, ExtensibleEntityDto<TPrimaryKey> {}
/** 实体审计用户扩展属性数据传输对象 */
interface ExtensibleAuditedEntityWithUserDto<TPrimaryKey, TUserDto> extends AuditedEntityWithUserDto<TPrimaryKey, TUserDto>, ExtensibleEntityDto<TPrimaryKey> {}
/** 实体审计全属性扩展数据传输对象 */
interface ExtensibleFullAuditedEntityDto<TPrimaryKey> extends ExtensibleEntityDto<TPrimaryKey>, FullAuditedEntityDto<TPrimaryKey> {}
/** 实体审计用户全属性扩展数据传输对象 */
...
/** 最大请求扩展数据传输对象 */
interface ExtensibleLimitedResultRequestDto extends ExtensibleObject, LimitedResultRequestDto {}
/** 排序请求数据传输对象 */
...
/** 分页排序请求扩展数据传输对象 */
interface ExtensiblePagedAndSortedResultRequestDto extends ExtensibleObject, PagedAndSortedResultRequestDto {}
/** 列表数据传输对象 */
...
/** 列表扩展数据传输对象 */
interface ExtensibleListResultDto<T> extends ExtensibleObject, ListResultDto<T> {}
/** 分页列表数据传输对象 */
...
/** 分页列表扩展数据传输对象 */
interface ExtensiblePagedResultDto<T> extends ExtensibleObject, PagedResultDto<T> {}
/** 分页列表扩展数据传输对象 */
interface ExtensiblePagedResultRequestDto extends ExtensibleObject, PagedResultRequestDto {}
/** 应用程序本地化资源数据传输对象 */
