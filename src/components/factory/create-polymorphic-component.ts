type ExtendedProps<Props = any, OverrideProps = any> = OverrideProps & Omit<Props, keyof OverrideProps>;
...
type InheritedProps<C extends ElementType, Props = any> = ExtendedProps<PropsOf<C>, Props>;

export type PolymorphicRef<C> = C extends React.ElementType ? React.ComponentPropsWithRef<C>["ref"] : never;

export type PolymorphicComponentProps<C, Props = any> = C extends React.ElementType
