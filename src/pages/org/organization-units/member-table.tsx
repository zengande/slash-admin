...
const OrganizationUnitMemberTable = forwardRef<OrganizationUnitMemberTableRef, OrganizationUnitMemberTableProps>(
	({ organizationUnitId, organizationUnitName, onAddMember }, ref) => {
		...
		const fetchMembers = () => {
			...
			setLoading(true);
			getUserListApi(organizationUnitId, { onlyDirectMembers, includeDetails: true })
				.then((rsp) => {
